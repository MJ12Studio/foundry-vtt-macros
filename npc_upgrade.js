/*
    ...
    2. Must-Have features for public-release:
        ...
        * Basics of Biography
        * Template-ize armor. Mages are getting armor like fighters
        ...
        Q: Can we have [semi-]permanent settings for our macros?
            A: Yes. Use world flags.
        Q: Can we add a Utility to the HUD to launch our macros(s)
            A: Yes, but it is manual for now. Posted a question about a macros for this on
                the Issue page for Token Action HUD

        =============== To-Do's =================================================================

        == Narrative / Biography ==    
        Done * Should we choose Gender?  May help choose things like jewelry
        Done * Show basic info.
    ...
    *** Oracle for NPC decisions/actions/behaviors
    
    *** Loot macro to easily pull all selected [dead] NPCs and get all their items and loot
          on a single page. Maybe dump all items and loot into a single treasure chest.
